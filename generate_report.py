...
def generate_pdf(interval="weekly"):
    ...
    if interval == "weekly":
        ...
        doc_name = (
            f"{repo_name}"
            f"_Weekly_Progress_Report"
            f"_Form-3_{date_stamp}.pdf"
        )
        ...
        doc_name = (
            f"{repo_name}"
            f"_Final_Report_{date_stamp}.pdf"
        )
    ...
    # =========================================================
    # 1. Header with College & Department Name
    # =========================================================
    ...
    if not student_logs:
        ...
        story.append(
            Paragraph(
                "<i>"
                "No commit logs found for this timeframe."
                "</i>",
                styles["Normal"]
            )
        )
